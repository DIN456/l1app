      ...
      <div class="container-fluid"> 
        ...
        <div class="card">
          ...
          <div class="card-body">
            ...
            if ( $query ) {
              echo "<center>ลบข้อมูลสำเร็จ<br><br><< <a  href=\"data-user.php\">ตกลง</a> >></center>";
            } else {
              echo "<center>ลบข้อมูลไม่สำเร็จ<br><br><< <a  href=\"data-user.php\">ตกลง</a> >></center>";
            }
