                ...
                <div class="container-fluid">
                    ...
                    <div class="card">
                        <div class="card-header bg-success">
                            <h5 class="card-text">ย้ายรายการนี้ไปทบทวน</h5>
                        </div>
                        <div class="card-body">
                            <?php
                            include('../config.php');
                            ...
                            //  echo $id, $rm_subcategory, $rm_dep_id, $date;
                            // exit;

                            $sql = "INSERT INTO tb_m (id,id_rm,rm_subcategory,rm_dep_id,date) 
		VALUES ('','$id','$rm_subcategory','$rm_dep_id','$date')";

                            $query = mysqli_query($objCon, $sql);

                            if ($query) {
                                include('update_rm.php');
                                echo "<center>ย้ายรายการสำเร็จ<br><br><a  href=\"list_rm.php\">ตกลง</a></center>";
                            } else {
                                echo "<center>ย้ายรายการไม่สำเร็จ<br><br> <a  href=\"list_rm.php\">ตกลง</a></center>";
                            }
