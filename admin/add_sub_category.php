      ...
      <div class="container-fluid"> 
        ...
        <div class="card">
          ...
          // exit;
            ...
            $sql = "INSERT INTO tb_subcategory (subcategory,name,category) 
		VALUES ('','$name','$category')";

            $query = mysqli_query( $objCon, $sql );

            if ( $query ) {
              echo "<center>เพิ่มข้อมูลสำเร็จ<br><br><< <a  href=\"sub_category.php\">ตกลง</a> >></center>";
            } else {
              echo "<center>เพิ่มข้อมูลไม่สำเร็จ<br><br><< <a  href=\"sub_category.php\">ตกลง</a> >></center>";
            }
