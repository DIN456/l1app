      ...
      <div class="container-fluid"> 
        ...
        <div class="card">
          ...
          //exit;
            ...
            $sql = "INSERT INTO tb_location (id,location) 
		VALUES ('','$location')";

            $query = mysqli_query( $objCon, $sql );

            if ( $query ) {
              echo "<center>เพิ่มข้อมูลสำเร็จ<br><br><< <a  href=\"location.php\">ตกลง</a> >></center>";
            } else {
              echo "<center>เพิ่มข้อมูลไม่สำเร็จ<br><br><< <a  href=\"location.php\">ตกลง</a> >></center>";
            }
