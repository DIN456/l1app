        ...
        <div class="card">
          ...
          <div class="card-body">
           ...
           //exit;
            ...
            $sql = "INSERT INTO tb_category (category,name) 
		VALUES ('','$name')";

            $query = mysqli_query( $objCon, $sql );

            if ( $query ) {
              echo "<center>เพิ่มข้อมูลสำเร็จ<br><br><< <a  href=\"category.php\">ตกลง</a> >></center>";
            } else {
              echo "<center>เพิ่มข้อมูลไม่สำเร็จ<br><br><< <a  href=\"category.php\">ตกลง</a> >></center>";
            }
