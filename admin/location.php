...
<div class="wrapper"> 
  ...
  <div class="content-wrapper"> 
          ...
          <div class="col-sm-12">
            <div class="card">
              <div class="card-header bg-fuchsia">
                <h5 class="card-text">เพิ่มรายการสถานที่</h5>
              </div>
              <div class="card-body">
    ...
    <label for="exampleFormControlInput1">รายการสถานที่</label>
    <input type="text" class="form-control" name="location" placeholder="รายการสถานที่" required>
  </div>
                ...
                <table id="example1" class="table table-bordered table-hover">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td align="center"><a href="edit_location.php?ID=<?php echo $result["id"]; ?>">
                        <button type="button" class="btn btn-warning">แก้ไข</button>
                        </a></td>
                      <td align="center"><a href="delete_location.php?ID=<?php echo $result["id"]; ?>">
