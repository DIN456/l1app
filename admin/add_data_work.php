      ...
      <div class="container-fluid"> 
        ...
        <div class="card">
         ...
         //  exit;
            ...
            $sql = "INSERT INTO tb_department (dep_id,main_dep,name) 
			VALUES ('','$main_dep','$name')";

            $query = mysqli_query( $objCon, $sql );

            if ( $query ) {
              echo "<center>เพิ่มข้อมูลสำเร็จ<br><br><< <a  href=\"work.php\">ตกลง</a> >></center>";
            } else {
              echo "<center>เพิ่มข้อมูลไม่สำเร็จ<br><br><< <a  href=\"work.php\">ตกลง</a> >></center>";
            }
