  ...
  <div class="content-wrapper"> 
    ...
    <section class="content">
      <div class="container-fluid"> 
		...
		$sql2 = "SELECT * FROM tb_category where category = $ID ";
          ...
          <div class="col-sm-12">
            <div class="card">
              <div class="card-header bg-pink">
                <h5 class="card-text">แก้ไขหมวดหมู่ความเสี่ยง</h5>
              </div>
              <div class="card-body">
                <form action="add_edit_category.php" method="post">
                  <div class="card-body">
                   <?php while ( $result2 = mysqli_fetch_array( $query2, MYSQLI_ASSOC ) ) { ?>
					  <div class="form-group">
                      
                      <input type="hidden" class="form-control" value="<?php echo $result2['category']; ?>"name="category">
                    </div>
					  <div class="form-group">
