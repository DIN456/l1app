      ...
      <div class="container-fluid"> 
        ...
        <div class="card">
          ...
          <div class="card-body">
            ...
            $ID = $_GET[ "ID" ];
            $sql = "DELETE FROM tb_department_group
			WHERE main_dep = '" . $ID . "' ";
            ...
            if ( $query ) {
              echo "<center>ลบข้อมูลสำเร็จ<br><br><< <a  href=\"department.php\">ตกลง</a> >></center>";
            } else {
              echo "<center>ลบข้อมูลไม่สำเร็จ<br><br><< <a  href=\"department.php\">ตกลง</a> >></center>";
            }
