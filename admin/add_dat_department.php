        ...
        <div class="card">
          ...
          <div class="card-body">
           ...
           //exit;
            ...
            $sql = "INSERT INTO tb_department_group (main_dep,dep_name) 
		VALUES ('','$dep_name')";

            $query = mysqli_query( $objCon, $sql );

            if ( $query ) {
              echo "<center>เพิ่มข้อมูลสำเร็จ<br><br><< <a  href=\"department.php\">ตกลง</a> >></center>";
            } else {
              echo "<center>เพิ่มข้อมูลไม่สำเร็จ<br><br><< <a  href=\"department.php\">ตกลง</a> >></center>";
            }
