        ...
        <div class="container-fluid">
          ...
          <div class="card">
            <div class="card-header bg-danger">
              <h5 class="card-text">แก้ไขรายการความเสี่ยง</h5>
            </div>
            <div class="card-body">
              <?php
              include('../config.php');
              ...
              $sql = "UPDATE tb_subcategory SET category = '$category', name = '$name' 
			WHERE subcategory = $id";

              $query = mysqli_query($objCon, $sql);

              if ($query) {
                echo "<center>แก้ไขข้อมูลสำเร็จ<br><br><< <a  href=\"sub_category.php\">ตกลง</a> >></center>";
              } else {
                echo "<center>แก้ไขข้อมูลไม่สำเร็จ<br><br><< <a  href=\"sub_category.php\">ตกลง</a> >></center>";
              }
