  ...
  <div class="wrapper">
    ...
    <div class="content-wrapper">
      ...
      <section class="content">
		...
		INNER JOIN  tb_subcategory ts ON t.rm_subcategory = ts.subcategory
    WHERE t.status = 1
		ORDER BY t.id DESC ";
            ...
            <div class="col-sm-12">
              <div class="card">
                <div class="card-header bg-danger">
                  <h5 class="card-text"> รายการรับแจ้งความเสี่ยง [นับสถานะเท่ากับ 1 เท่านั้น]</h5>
                </div>
                <div class="card-body">
                    ...
                    <tbody>
                      ...
                      ?>
                        <tr>
                          ...
                          <td align="center"><a href="rm_details.php?ID=<?php echo $result["id"]; ?>">
